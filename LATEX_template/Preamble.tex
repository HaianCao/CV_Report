...
\usepackage{array}
\usepackage{multirow}
\usepackage[figuresleft]{rotating} % Để xoay ngang hình ảnh (xoay lật lại)
...
% ---------- Header & Footer ----------
\usepackage{fancyhdr}
% ensure header height to avoid layout warnings/overflow
...
\renewcommand{\listfigurename}{\centering\Large\bfseries DANH SÁCH HÌNH VẼ}
\renewcommand{\listtablename}{\centering\Large\bfseries DANH SÁCH BẢNG}
